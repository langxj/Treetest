...
public class MyAdapter extends BaseAdapter {
	...
	public MyAdapter(Context context, ArrayList<ArrayList<String>> lists,int iVal,int iVal1) {
		super();
	...
	public View getView(int index, View view, ViewGroup arg2) {
		...
		if(view == null)
		{
			...
			if(iWidth==1920 && iHeight ==1128)
			   view = inflater.inflate(R.layout.list_itembig, null);
			else if(iWidth==1024 && iHeight ==720)
			   view = inflater.inflate(R.layout.list_itemmid, null);
			else
			   view = inflater.inflate(R.layout.list_itemsmall, null);
		}
